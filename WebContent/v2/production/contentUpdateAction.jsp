...
<jsp:setProperty name="content" property="id" />
...
<jsp:setProperty name="content" property="seq" />
        ...
        if(session.getAttribute("userID") !=null ){
            ...
            if(userID ==null) {
                ...
                if(content.getTitle() == null || content.getText() == null ) {
                    ...
                    System.out.println("content.getPid()===>"+content.getPid());
                    System.out.println("content.getSeq()===>"+content.getSeq());
                    */
                    
                    //public int updateContent(int contentId, String Title, String text,   String imgurl, String pid, String seq) {
                    int result = contentDAO.updateContent(content.getId(),content.getTitle(),content.getText(), content.getContentsImgUrl(), content.getPid(), content.getSeq());
                    ...
                    if(result == -1){
                        ...
                        PrintWriter script = response.getWriter();
                        script.println("<script>");
                        script.println("location.href='contentDetail.jsp?bookId="+content.getBookId()+"&contentId="+content.getId()+ "'");
                        script.println("</script>");
                    }
                }
            }
