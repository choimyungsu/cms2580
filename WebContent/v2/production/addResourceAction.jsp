    ...
    String[] ArrayCheckValue = ArrayCheck.split(",");
        ...
        if(userID ==null) {
           ...
           // RfpuserlistDAO rfpuserlistDAO = new RfpuserlistDAO();
            		System.out.println("ArrayCheckValue.length==>"+ArrayCheckValue.length);
            ...
            //script.println("opener.parent.location.href ='acl.jsp?rfpid="+rfpid+"'");
            script.println("opener.location.href ='authResource.jsp?rfpid="+rfpid+"'");
