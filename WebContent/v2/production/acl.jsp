...
function changeResource(authCd) {
	document.form1.target = "resultExam";
	document.form1.action = "authResource.jsp";
	document.form1.authCd.value = authCd;
	document.form1.submit();
	//alert("눌렀다.");
}
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
	                ...
	                <%
                        ...
                        Util util = new Util();
                        ArrayList<Aclauth> list = aclDAO.authList();
                       for(int i =0 ; i < list.size() ; i++){
                    %>
	                        <tr>
	                          <th scope="row"><%= i+1 %></th>
	                          <td onclick="changeResource('<%= list.get(i).getAuthCd() %>');"><a href ="#"><%= list.get(i).getAuthCd() %></a></td>
	                          <td><%= list.get(i).getAuthNm() %></td>
	                        </tr>
	                  <% } %> 
                      ...
                      <div class="col-sm-9 mail_view">
                        <div class="inbox-body">
                          ...
                          <iframe id="resultExam" src="authResource.jsp" name="resultExam" style="display:block; width:100%; height: 70vh; frameborder:0"> </iframe>
