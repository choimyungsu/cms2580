        ...
        if(session.getAttribute("userID") !=null ){
            ...
            if(userID ==null) {
                ...
                if(Examcontents.getSubject() == null || Examcontents.getSubject() == null ) {
                    ...
                    int result = examcontentsDAO.insertContents(Examcontents.getExamcode(),Examcontents.getSeq(),Examcontents.getDomain(), Examcontents.getSubject(), Examcontents.getDefinition() ) ;//
                    ...
                    if(result == -1){
                        PrintWriter script = response.getWriter();
                        script.println("<script>");
                        script.println("alert('Word 생성에 실패했습니다.')");
                        script.println("history.back()");
                        script.println("</script>");                    
                    }else{
                        PrintWriter script = response.getWriter();
