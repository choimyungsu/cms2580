					...
					<img src="img/t.png" class="t" style="position:absolute; top:0px; left:0px; display:none;">
					  ...
					  <hr>	
						...
						%>
							...
							<%
 								if(examcode.equals("B007")){
 							%> ⑤ <input type=radio name="checkanswer0" value="5"> <!-- 공인중개사 시험 --> <%
 	}
 %>		
								</div>
							</div>
						...
						%>
							...
							<div class="row">
								...
								%> 	
									<%
 											if(examlist.getAnswerdesc() !=null && examlist.getAnswerdesc().length()> 0){
 										%><button type="button" class="btn btn-primary btn-sm " onclick="comment( '0');">해설</button> <%
 	}
 %>
									...
									<button type="button" class="btn btn-primary btn-sm " onclick="window.history.back();">뒤로</button>
								    <%
