    ...
    <div class="content row" style="margin-top:0;">
        <div class="col-sm-3" id="leftmenuinner" style="overflow-y:auto; border-right:1px solid #BDBDBD">
            ...
            <div class="row">
				...
				<%-- d.add(<%=list.get(i).getId()  %>,<%=list.get(i).getPid()  %>,'<%=list.get(i).getTitle()  %>','contentDetail.jsp?contentId=<%=list.get(i).getId() %>&bookId=<%=bookId%>'); --%> //목차시작
...
/* 
					        d.add(1,0,'Node 1','example01.html'); //목차시작
					        d.add(3,1,'Node 1.1','example01.html');
					        d.add(4,0,'Node 3','example01.html','useSelection=true');
