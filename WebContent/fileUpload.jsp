					...
					<div class="row" style="padding-left:20px;">
						<form method="post" action="fileUploadAction.jsp" enctype="multipart/form-data">
						       ...
						       <div class="form-group">
			                        <input type=radio name="type" id="type" value="A"> 기사유형(객관식)
			                        <input type=radio name="type" id="type" value="B"> 기술사유형(주관식)
			                        <input type=radio name="type" id="type" value="C"> 컨텐츠목록
			                    </div>
